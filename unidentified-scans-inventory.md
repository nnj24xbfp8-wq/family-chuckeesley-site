...
- ~~`family-group-picket-fence-porch-c1940s-queued-for-id`~~ — **PLACED** as artifact [`hill-davis-family-mt-perry-porch-c1940s`](/archive/hill-davis-family-mt-perry-porch-c1940s/) (renamed `hill-davis-family-mt-perry-porch-c1940s.jpeg`). Maternal Hill–Davis line at the Hill home in **Mt. Perry, Perry County, Ohio** (NE of Somerset, beyond Zanesville). **All ten identified by Chuck** (labeled photo), L→R: Homer Davis, Theodore "Ted" R. Hill, Christine (Miller) Hill*, Louella "Lovella" (Hill) Beardmore, Dorothy Davis, Bessie Marie Davis, Betty (Davis) Wolfe, Janetta "Jeanette" (Smith) Hill (=Harvey's mother, existing page `janetta-smith`), Clara Victoria Ullmann Hill, Harvey Hendershot Hill. **Four generations** of the maternal Hill line. Date tightened to **c. 1938–1941** (Clara d. 15 Oct 1941 is in frame). NOT the Bexley/Cassady house. *Only Christine (Miller) Hill (Ted's wife) has no archive page yet — candidate to add.
...
- ~~`places/2018-03-30-0015.jpeg`~~ & ~~`places/IMG_1920.jpeg`~~ — **PLACED** as a then/now pair in the new place entry [`stuttgart-schlossplatz`](/places/stuttgart-schlossplatz/). The 1992 scan is Robert Earl Wildermuth's captioned print of a Schlossplatz fountain (R.E.W. wrote "Königsplatz"; corrected to Schlossplatz — the 1863 twin fountains by the Neues Schloss); IMG_1920 is Chuck's 2018 return frame. Moved into `places/stuttgart-schlossplatz/{1992,2018}/`. Adds Stuttgart to the Wildermuth pilgrimage route alongside Rielingshausen and Marbach.
