---
name: "Charles Eric 'Chuck' Eesley"
aka: "Chuck"
line: paternal
birth:
...
The pieces of original work Chuck has so far contributed to the line's documentary record:

- The [eulogy for his father, Charles McMaster Eesley](/docs/eulogy-charles-mcmaster-eesley/), delivered at the memorial service in late 2015.
- The [memorial speech for his mother, Terrie Lee Bain](/docs/memorial-speech-terrie-lee-bain/), delivered at her memorial service on 8 July 2017.
- The [Oxford public library research](/docs/eesley-line-research-notes/) he and [Lijie](/family/lijie-zhou/) commissioned together in 2018, which closed the Hanwell/Stratford generation back to Joseph Eesley and Frances Ayris.
- The [ten threads of inherited practice across the family](/docs/family-threads/) &mdash; values, lessons, and patterns named across the existing archive in this synthesis essay, from education-as-inheritance through the multi-generational Japan-and-China curiosity, the four-generation crossing impulse that runs from Johann Michael Wildermuth in 1847 to Lijie in the present, the entrepreneurial habit of building things that turns reflective in this generation, and the service-and-stewardship thread that runs from the First Congregational endowment to the [Zhou & Eesley Family Foundation](https://zhoueesleyfoundation.com).
- This archive itself, threading those documents through the photographs, places, and people that surround them.
