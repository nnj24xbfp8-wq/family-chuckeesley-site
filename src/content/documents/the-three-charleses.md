...
So the first name *Charles* carries from grandfather to grandson across the first skip, and then from father to son in the next generation. It is a grandfather-and-grandson naming pattern across a single skipped generation, then it converts into a father-and-son pattern at the present generation.
