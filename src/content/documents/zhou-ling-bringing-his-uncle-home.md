...
<figure class="not-prose my-6">
  <figcaption class="text-sm text-ink/70 mb-2 italic">其一 &mdash; 接叔叔一家回青岛（2分12秒）</figcaption>
  <audio src="/recordings/zhou-ling-uncle-home-1-the-story.mp3" controls preload="none" class="w-full"></audio>
</figure>

<figure class="not-prose my-6">
  <figcaption class="text-sm text-ink/70 mb-2 italic">其二 &mdash; "为什么是你父亲去办？"（44秒）</figcaption>
  <audio src="/recordings/zhou-ling-uncle-home-2-why-him.mp3" controls preload="none" class="w-full"></audio>
</figure>

## 译录 &mdash; 丽婕席间口译

*以下为丽婕英译的中文回译。口语记录已略去语气词与重复，词句照旧；不确处以方括号标出。原始录音中周玲以中文讲述，丽婕译为英文，故此处所录实为"转述之转述"。*
...
我父亲帮的这件事是这样 &mdash; 我爷爷的母亲去世〔前〕，她有个心愿，就是想让小儿子回来。所以我父亲 &mdash; 就像他今天在啤酒博物馆做的那样，我也说不清，开车也好、找朋友也好 &mdash; 他跟很多人谈，最后找到了能把人办回来的人。这事办了好几年吧，我想。他那时候已经六十多了，大概。
...
在当年的**户口**与**工作调动**制度下，人不能自行迁居城市。城镇户口是配给制的，工作岗位由单位与主管部门分配，跨地区调动须由调出、调入两边的单位和人事部门层层签字批准 &mdash; 何况是从贫困县医院调进青岛这样的大城市，名额本就极少。所以"办调动"不是搬家，是一场行政审批的长跑；托人、走动、送礼，是这套制度下普通人唯一可用的办法。周玲手记里写到他陪叔叔"到经办人家里去送礼"，说的正是这件事。

叔叔自己办了多年没办成；侄子办成了。差别不在诚意，在**关系**。
...
旧述亦出自家人之口，非虚构；只是压缩转述之后走了样。今以周玲本人的口述为准。
...
<figure class="not-prose my-6">
  <figcaption class="text-sm text-ink/70 mb-2 italic">Part 1 &mdash; bringing the uncle's family back (2 min 12 sec)</figcaption>
  <audio src="/recordings/zhou-ling-uncle-home-1-the-story.mp3" controls preload="none" class="w-full"></audio>
</figure>

<figure class="not-prose my-6">
  <figcaption class="text-sm text-ink/70 mb-2 italic">Part 2 &mdash; "why was it your dad's responsibility?" (44 sec)</figcaption>
  <audio src="/recordings/zhou-ling-uncle-home-2-why-him.mp3" controls preload="none" class="w-full"></audio>
</figure>

### Transcript &mdash; Lijie translating at the table

*Lightly cleaned: filler words and false starts removed, wording otherwise left as spoken. Uncertain readings are in [brackets]. What follows is a translation of a translation &mdash; Zhou Ling spoke in Chinese and his daughter rendered him in English in real time, so the voice on the page is hers and the account is his.*
...
>
> And so the story my dad helped was &mdash; [before] my grandfather's mother passed away, she had this wish that she wants her youngest son to come back. So my dad &mdash; like today, what he did at the beer museum, I don't know, drive, or find friends &mdash; he talked to many people, and eventually he finds someone to get this person back. It took years, I think. He's already in his sixties, maybe.
>
...
**What "getting someone back" actually meant**

Under the **hukou** household-registration system and the job-transfer rules that went with it, a person could not simply move to a city. Urban registration was rationed, jobs were allocated by work units and their supervising bureaus, and a transfer between regions required the releasing unit, the receiving unit and the personnel authorities on both ends to sign off &mdash; all the more so for a move from a poor county hospital into a city like Qingdao, where the quota of places was tiny.

So "arranging a transfer" was not moving house. It was a years-long administrative campaign, and working through intermediaries &mdash; visits, favours, gifts carried to officials' homes &mdash; was the only instrument an ordinary family had. When the handwritten pages describe Zhou Ling going with his uncle **to the homes of the officials handling it, to bring them gifts**, this is what they are describing.

The uncle petitioned for years and failed. His nephew succeeded. The difference was not sincerity. It was **connections**.
...
The earlier telling came from the family too. It is not invented &mdash; it is what a story looks like after a couple of compressions. Zhou Ling's own spoken account now takes precedence.

### Who is who

| In the transcript | Name | Relation to Lijie |
|---|---|---|
