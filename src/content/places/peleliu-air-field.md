...
> *"The Japanese AA defenses around the navy guns used sonar-controlled searchlights — picking up aircraft by sound rather than radar. The countermeasure: change propeller pitch in flight to change the engine sound signature. Sure enough on the next flight, we gave this procedure a try and just as surely it worked. The Japs spent the whole time we were in the target area trying to pick us up."*

The propeller-pitch trick became a 22nd BG standard for the Taiwan-from-Peleliu mission set.
...
The 22nd BG had moved forward to [Leyte Air Field at Tacloban](/places/leyte-air-field-tacloban/) in the Philippines, and the attached Jolly Roger crew went with them.

## After the war

Peleliu Air Field's wartime strip is largely gone today; the present-day airport on the island is small civilian-only. The 1st Marine Division's battlefield is preserved as a U.S. National Park unit, and the Japanese coral-cave defenses are open to visitors. The Pacific War Museum on Peleliu records the casualties and the controversy.

> *Sources: [The Big One](/docs/the-big-one/), Phase 2 (22nd BG attachment); [Robert Earl Wildermuth's 1989 memoir](/docs/robert-earl-wildermuth-memoir/) (Peleliu sleeper passage); [Battle of Peleliu](https://en.wikipedia.org/wiki/Battle_of_Peleliu) on Wikipedia.*
