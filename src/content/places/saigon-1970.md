---
title: "Saigon, 1969–1971"
village: "Saigon"
region: "Republic of Vietnam (now Ho Chi Minh City, Vietnam)"
country: "Vietnam"
coords:
  lat: 10.7626
  lng: 106.6602
summary: "The city Charles McMaster 'Charlie' Eesley wrote home from during his 1969–1971 U.S. Army tour. The letters that survived the trip back to Marietta, Ohio are the primary record of his two years there — a span he carried with him for the next four and a half decades and the subject of the [Letters from Vietnam](/docs/letters-from-vietnam/) collection in this archive."
...
visits:
  ...
  - year: "June 2011"
    ...
    images:
      - ../../assets/family/originals/IMG_0276.jpeg
      - ../../assets/family/originals/IMG_0279.jpeg
    caption: "Chuck's first visit to Vietnam — Ho Chi Minh City, June 2011 — to see his childhood friend Mike Sieburg who was living there at the time. The two photographs are from the Cu Chi tunnels — the Viet Cong underground tunnel network 70 km northwest of HCMC, now a Vietnamese government tourist site. In the first, Chuck sits with four Vietnamese reenactors in NLF (Viet Cong) uniforms under the woven camouflage netting that hides the surface entry to a tunnel complex. In the second, Chuck sits on the turret of a destroyed American M48 Patton tank preserved at the site — captured or disabled during the war, left in place as memorial. The trip also included the War Remnants Museum (formerly the 'American War Museum,' the Vietnamese state museum documenting the war from the Vietnamese perspective). From Saigon Chuck called his father by Skype; Charlie told stories about being in that city, and when Chuck complained of the humidity, Charlie said he had 'missed the wonderful experience of the monsoons.' Source: Chuck's [eulogy for his father](/docs/eulogy-charles-mcmaster-eesley/), 2015, and Chuck's own account 2026."
    alignmentNote: "The Cu Chi tunnels and the War Remnants Museum are the two most-canonical sites for an American visitor with a father who served in country. That Chuck sat on the turret of an American tank that Vietnamese forces had defeated, while his father had been a U.S. infantryman in the same country four decades earlier, is the photograph's quiet historical layering."
  - year: "2010s–2020s"
    narrator: charles-eric-eesley
    photographer: charles-eric-eesley
    images:
      - ../../assets/family/originals/Image 9.jpeg
    caption: "Chuck has returned to Ho Chi Minh City multiple times in the years since the June 2011 first visit, including teaching trips at local universities with the family foundation. The photograph shows Chuck giving a presentation in a lecture hall at the **UEH-International School of Business (UEH-ISB), University of Economics Ho Chi Minh City** — the lectern in front of a projection screen reading 'Ignite Your Business Potential with Intrapreneurship,' the audience of Vietnamese students around three long conference tables. The two-generation geography of Charlie's 1969–71 tour and Chuck's 2010s–2020s teaching career produces an unusual parental-paternal symmetry: the city the father refused to revisit became one the son returned to repeatedly to teach business and entrepreneurship to its university students."
    alignmentNote: "The lecture-hall photograph and the Cu Chi tunnel photographs together make this place's visit history the most layered in the archive — the same geographic point sitting under a soldier's tour, a son's tourist visit, a documentary letter sequence, and a returning academic's classroom."
---
...
- [Letters from Vietnam](/docs/letters-from-vietnam/) &mdash; the curated collection of Charlie's surviving letters home.
- [Eulogy for Charles McMaster Eesley](/docs/eulogy-charles-mcmaster-eesley/) (Chuck Eesley, 2015) &mdash; the source for the Vietnam-after-Vietnam content woven through the family's later life.
- [*The Vietnam War*](https://www.pbs.org/kenburns/the-vietnam-war/) (Ken Burns &amp; Lynn Novick, 2017) &mdash; the documentary series.
...
- [Vietnam Veterans Memorial Fund](https://www.vvmf.org/) &mdash; the searchable wall directory.
- [Saigon (Wikipedia)](https://en.wikipedia.org/wiki/Ho_Chi_Minh_City) &mdash; the city's history and its renaming after the war.
